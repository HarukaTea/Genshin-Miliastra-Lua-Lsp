...
function start(context, documentSelector, folder) {
    ...
    let develop = config.get("miliastraLsp.develop.enable");
    let debuggerPort = config.get("miliastraLsp.develop.debuggerPort");
    let debuggerWait = config.get("miliastraLsp.develop.debuggerWait");
    let commandParam = config.get("miliastraLsp.misc.parameters");
    let command;
