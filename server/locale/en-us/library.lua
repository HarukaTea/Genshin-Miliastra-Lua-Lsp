...
elapsedTime = 'Returns how much time has elapsed since the current game session started.'
...
settings = 'Returns the global settings object.'
shared = ''
...
typeof = 'Returns the type of the object specified, as a string. This function is more accurate than Lua’s native ``type`` function, as it does not denote engine-specific types as userdata.'
unpack = '-------\n```lua\nreturn list[i], list[i+1], ···, list[j]\n```\n'
utf8 = ''
