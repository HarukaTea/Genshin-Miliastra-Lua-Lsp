...
DIAG_DIAGNOSTICS        = '千星奇域 LSP Diagnostics.'
DIAG_TYPECHECKING       = '千星奇域 LSP Type Checking.'
...
WINDOW_CHECK_TYPECHECKING        = 'The type-checking is experimental and incomplete. Using [Luau LSP](https://marketplace.visualstudio.com/items?itemName=JohnnyMorganz.luau-lsp) for static typing is always recommended.'
